...
def build_app() -> Application:
    ...
    app.add_handler(CommandHandler("reminders", usr.cmd_reminders))
    ...
    app.add_handler(CallbackQueryHandler(usr.on_survey_choice, pattern=r"^survey:"))
    ...
    app.add_handler(CommandHandler("pause", adm.cmd_pause))
    app.add_handler(CommandHandler("resume", adm.cmd_resume))
    ...
    app.add_handler(CommandHandler("surveynew", adm.cmd_surveynew))
    app.add_handler(CommandHandler("surveyoption", adm.cmd_surveyoption))
    app.add_handler(CommandHandler("surveys", adm.cmd_surveys))
    app.add_handler(CommandHandler("surveysend", adm.cmd_surveysend))
    app.add_handler(CommandHandler("surveyresults", adm.cmd_surveyresults))
    app.add_handler(CommandHandler("surveyclose", adm.cmd_surveyclose))
    ...
    app.add_handler(CommandHandler("knocks", adm.cmd_knocks))
