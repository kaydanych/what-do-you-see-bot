...
STRINGS = {
    "ru": {
        ...
        "WELCOME": (
            ...
            "жизни — цвета, предметы, свет, тени, то, как один кадр может значить "
            ...
            "присылаю задание — например, «пришли фото с водой». До {deadline} "
            "(по Берлину) ты отправляешь мне своё фото, понимая задание так, как тебе близко, а "
    ...
    "en": {
        ...
        "WELCOME": (
            ...
            "the colours, the objects, the light, the shadows, how one moment can "
            "mean so many things to different pairs of eyes, how two photos can "
            "quietly click and connect on some deeper level. This game is a small "
            "nudge to notice, to capture, to share, and to look.\n\n"
            "Here's how it works. Every morning at {prompt_time} (Berlin time) I "
            "send a prompt — e.g. “send me a photo with water”. You send me "
            "your photo before {deadline} (Berlin time), following the prompt however it "
